...
set service dhcp-server shared-network-name LAN subnet 192.168.14.0/24 default-router '192.168.14.3'
set service dhcp-server shared-network-name LAN subnet 192.168.14.0/24 dns-server '192.168.14.3'
